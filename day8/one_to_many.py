...
app.config["SQLALCHEMY_TRACK_MODIFICATION"] = False #optional line, only for readability
...
class Team(db.Model):
    ...
    members = db.relationship("Player", backref="team")  #establish the foreign key, members is not a column
